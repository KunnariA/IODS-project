...
**This week's exercise included joining two datasets by identifier variables, conducting logistic regression, and cross-validating the model**
...
formula <- as.formula(paste("k.res2cluster", predictors, sep="~"))
